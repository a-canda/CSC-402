...
public class Main extends SwingApp {
   ...
   public void initListeners() {
      ...
      apply.addActionListener( new ActionListener() {
         public void actionPerformed( ActionEvent e ) {
            ...
            if (intro.isSelected()) {t = t.accept( new intro( "i"+layerno ), Visitor.getInstance()); }
   ...
   void clearModuleExpression() {
       ActionListener[] al = clear.getActionListeners();
       for (ActionListener l : al) { 
           l.actionPerformed(null); 
       }
   } 
   void applyQuark() {
       ActionListener[] al = apply.getActionListeners();
       for (ActionListener l : al) { 
           l.actionPerformed(null); 
       }
   }
   
   void setModelType(String activeModel, boolean setSelect) {
       model.setActionCommand(activeModel);
       this.activeModel = activeModel;
       selected.setSelected(setSelect);
       updateQuarkPanel();
   }
